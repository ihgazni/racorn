...
var RegExpValidationState = exports.RegExpValidationState = function () {
  function RegExpValidationState(parser) {
    _classCallCheck(this, RegExpValidationState);
  ...
  _createClass(RegExpValidationState, [{
    key: "reset",
    value: function reset(start, pattern, flags) {
...
pp.regexp_pattern = function (state) {
  ...
  try {
    for (var _iterator = state.backReferenceNames[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
pp.regexp_eatQuantifier = function (state) {
  var noError = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
pp.regexp_validateUnicodePropertyNameAndValue = function (state, name, value) {
  if (!_unicodePropertyData2.default.hasOwnProperty(name) || _unicodePropertyData2.default[name].indexOf(value) === -1) {
    state.raise("Invalid property name");
  }
};
pp.regexp_validateUnicodePropertyNameOrValue = function (state, nameOrValue) {
  if (_unicodePropertyData2.default.$LONE.indexOf(nameOrValue) === -1) {
    state.raise("Invalid property name");
  }
};
...
pp.regexp_eatClassAtom = function (state) {
  ...
  if (state.eat(0x5C /* \ */)) {
    ...
    if (state.switchU) {
      ...
      if (_ch === 0x63 /* c */ || isOctalDigit(_ch)) {
