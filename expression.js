...
pp.checkParams = function (node, allowDuplicates) {
  ...
  try {
    for (var _iterator2 = node.params[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
pp.checkUnreserved = function (_ref3) {
  ...
  if (re.test(name)) {
    if (!this.inAsync && name === "await") this.raiseRecoverable(start, "Can not use keyword 'await' outside an async function");
